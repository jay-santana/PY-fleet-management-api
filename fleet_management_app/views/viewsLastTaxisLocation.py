...
from ..utils import LastTaxisLocationUtils
...
def lastTaxisLocation(request):
    ...
    if request.method == 'GET':
        ...
        last_locations_utils = LastTaxisLocationUtils(request)
...
lastTaxisLocation = last_taxis_location_schema(method='get')(lastTaxisLocation)
